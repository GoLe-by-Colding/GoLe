      ...
      <article className="mx-auto max-w-3xl px-6 py-16 [word-break:keep-all]">
        ...
        <div className="space-y-10 text-sm leading-7 text-neutral-700">
          ...
          <Section title="제7조 (거래 및 결제)">
            <p>
              플랫폼 결제가 활성화된 단계에서는 별도 화면에 고지된 결제대행사를 통해 결제
              승인·취소를 처리합니다. 결제 및 판매자 지급 기능은 관련 계약과 운영 준비가 완료된
              경우에만 제공하며, 비활성화된 동안에는 이용자 간 채팅을 통한 직접 거래만 지원합니다.
            </p>
            <ul className="list-disc space-y-1 pl-5">
              <li>활성 결제수단과 처리 사업자는 결제 화면에서 확인할 수 있습니다.</li>
              <li>취소·환불 가능 시점과 절차는 주문 상태 및 거래별 고지에 따릅니다.</li>
            </ul>
          </Section>
