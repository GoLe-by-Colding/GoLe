      ...
      <article className="mx-auto max-w-3xl px-6 py-16 [word-break:keep-all]">
        ...
        <div className="space-y-10 text-sm leading-7 text-neutral-700">
          ...
          <Section title="3. 개인정보 보유 및 이용 기간">
            <ul className="list-disc space-y-1 pl-5">
              <li>
                회원 정보: 이메일 발송 기능이 활성화된 때에는 계정 설정에서 이메일 일회성 코드와
                확인 문구로 탈퇴를 요청할 수 있습니다. 이 요청이 접수되면 계정 접근과 모든 로그인
                세션을 즉시 종료합니다. 발송 준비 기간에는 운영자 이메일로 요청할 수 있고, 접수 후
                필요한 본인확인과 처리 절차를 별도로 안내합니다. 운영자가 진행 중인
                거래·정산·분쟁·신고, 문의 기록, 공개 콘텐츠 수명주기와 법령상 보존 대상을 확인한 뒤
                계정 핵심정보와 개인화 데이터를 파기합니다. 계속 보존해야 하는 기록은 해당 목적과
                기간 동안 분리 보관합니다.
              </li>
              <li>
          ...
          <Section title="5. 개인정보 처리 위탁">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                이메일 발송 기능 활성 시 Google LLC(Gmail) — 회원가입 인증번호·비밀번호 재설정·회원
                탈퇴 본인확인 메일 발송
              </li>
              <li>
          ...
          <Section title="6. 개인정보의 국외 처리 위탁">
            <p>
              운영자는 해당 기능이 활성화된 때 서비스 계약 체결·이행에 필요한 이메일 발송과 운영
              알림, 이용자가 선택한 방문 분석을 위해 개인정보 보호법 제28조의8에 따라 아래와 같이
              개인정보를 국외에서 처리 위탁·보관합니다. 같은 조 제2항의 고지 항목에 맞춰 이전 항목,
              국가, 시기·방법, 이전받는 자, 이용 목적·보유기간과 거부 방법·효과를 안내합니다.
            </p>
            <div className="space-y-4">
              <section className="rounded-xl border border-neutral-200 bg-neutral-50 p-4">
                <h3 className="font-semibold text-neutral-900">
                  이메일 발송 기능 활성 시 Google LLC(Gmail)
                </h3>
          ...
          <Section title="8. 개인정보 파기 절차 및 방법">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                이메일 발송 기능이 활성화된 때의 회원 탈퇴 요청은 로그인된 계정에서 이메일 일회성
                코드, 현재 이메일과 정확한 확인 문구를 함께 검증합니다. 접수와 동시에 계정을
                비활성화하고 모든 세션을 폐기하며, 일반 관리자 정지 해제로는 복구할 수 없습니다.
                이메일 발송 준비 기간에는 계정 보안 화면의 운영자 이메일로 요청할 수 있으며, 접수 후
                필요한 본인확인과 처리 절차를 별도로 안내합니다.
              </li>
              <li>
          ...
          <Section title="9. 이용자 권리">
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                이메일 발송 기능이 활성화된 때에는 로그인 후 프로필의 계정 보안 화면에서 회원 탈퇴를
                요청할 수 있고, 본인확인 뒤 즉시 로그아웃되며 처리 요청 ID가 발급됩니다. 발송 준비
                기간에는 같은 화면에 표시된 운영자 이메일로 탈퇴·삭제 요청을 접수합니다.
              </li>
          ...
          <Section title="11. 쿠키 및 브라우저 저장소">
            <p>
              ...
              이메일 가입 직후 인증 화면으로 넘길 이메일과 결제 시도 여부는 현재 탭의 세션 저장소에
              보관합니다. 인증 대기 이메일은 URL에 넣지 않으며 인증 성공, 회원 탈퇴 시 또는 탭을
              닫으면 삭제됩니다. 브라우저 설정에서 이를 지우거나 거부할 수 있으나 로그인·입력값 기억
              등 관련 기능이 제한될 수 있습니다. 회원 탈퇴 요청이 접수되면 요청을 접수한
              브라우저에서 화면 복원용 계정 정보, 최근 거래 연락처·카드 결제 이름, 인증 대기
              이메일과 해당 탭의 결제 시도 표식을 삭제합니다.
            </p>
            <p>
