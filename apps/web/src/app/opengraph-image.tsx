      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <div style={{ display: "flex", gap: "10px" }}>
            <div style={{ width: "26px", height: "26px", borderRadius: "9999px", background: "#facc15" }} />
            <div style={{ width: "26px", height: "26px", borderRadius: "9999px", background: "rgba(255,255,255,0.55)" }} />
          </div>
