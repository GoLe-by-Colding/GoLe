  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 윗면 — 정면과 폭이 같아 대가리 질량이 산다. 이마 모서리만 크게 굴린다. */}
        <path d="M8 64V52C8 34 21 22 40 22H180C189 22 196 29 196 38V64H8Z" fill="#6082F7" />
        ...
        {/* ── 스파인 플레이트: 등의 평평한 크라운에 얹혀 스터드 세 개가 윤곽에서
            그대로 솟는 단일 path. 분수 물줄기는 가운데 스터드 뒤에서 시작한다. ── */}
        <path
